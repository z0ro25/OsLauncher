...
import com.truongnt.ios.ioslite.common.ad.IOSListAd;
import com.truongnt.ios.ioslite.common.ad.IOSListAdListener;
import com.truongnt.ios.ioslite.common.ad.IOSNAdResponse;
import com.truongnt.ios.ioslite.common.debug.DebugLog;
import com.truongnt.ios.ioslite.common.view.IOSLoadingView;
import com.truongnt.ios.themeclub.R;
import com.truongnt.ios.themeclub.ThemeClubApplication;
import com.truongnt.ios.themeclub.adapter.WallPaperNewestAdapter;
import com.truongnt.ios.themeclub.base.BaseFragment;
import com.truongnt.ios.themeclub.bean.WallPaperJsonBean;
import com.truongnt.ios.themeclub.bean.WallPaperNewestPieceBean;
import com.truongnt.ios.themeclub.bean.WallPapersBean;
import com.truongnt.ios.themeclub.bean.request.WallPaperNewestRequest;
import com.truongnt.ios.themeclub.intertfaces.IViewShowDatas;
import com.truongnt.ios.themeclub.presenter.WallPaperNewestPresenter;
import com.truongnt.ios.themeclub.tools.ItemClickListener;
import com.truongnt.ios.themeclub.ui.activity.OnlineWallpapersDetailActivity;
import com.truongnt.ios.themeclub.ui.activity.SourceDetailActivity;
import com.truongnt.ios.themeclub.util.DensityUtils;
import com.truongnt.ios.themeclub.util.NetWorkUtils;
import com.truongnt.ios.themeclub.util.WallpaperUtil;
import com.truongnt.ios.themeclub.view.ItemDecoration;
...
//        mAdapter.setLoadingView(loadingView);
    ...
    public void initAd() {
        ...
        mIOSAdListener = new IOSListAdListener() {
            @Override
            public void onError(com.truongnt.ios.ioslite.common.ad.IOSAdError error) {
