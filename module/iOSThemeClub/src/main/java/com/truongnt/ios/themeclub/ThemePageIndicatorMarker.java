...
package com.truongnt.ios.themeclub;
...
public class ThemePageIndicatorMarker extends FrameLayout {
    ...
    public ThemePageIndicatorMarker(Context context) {
        this(context, null);
    }

    public ThemePageIndicatorMarker(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ThemePageIndicatorMarker(Context context, AttributeSet attrs, int defStyle) {
