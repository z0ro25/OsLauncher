package com.truongnt.ios.themeclub.dao;
...
public class ThemeContentProvide extends ContentProvider {
    ...
    static {
        sURIMatcher.addURI("com.truongnt.ios.themeclub.provide", "theme/#", THEME_SINGLE);
        sURIMatcher.addURI("com.truongnt.ios.themeclub.provide", "theme", THEME_MULTIPLE);
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (flag) {
            case THEME_SINGLE:
                return "vnd.android.cursor.item/vnd.com.truongnt.ios.themeclub.provide."
                        +DataBaseOpenHelper.DOWNLOAD_THEME_TABLE;
            case THEME_MULTIPLE:
                return "vnd.android.cursor.dir/vnd.com.truongnt.ios.themeclub.provide."
                        +DataBaseOpenHelper.DOWNLOAD_THEME_TABLE;
        }
        return null;
    }
