package com.truongnt.ios.themeclub.util;
...
import com.truongnt.ios.themeclub.bean.LockScreenNewestBean;
...
public class AppUtils {
    ...
    private static final String FILE_PATH_AUTHOITY = "com.truongnt.ios.themeclub.file.provider";
