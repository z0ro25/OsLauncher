...
import com.amz.ios.themeclub.MineThemeScroller;
import com.amz.ios.themeclub.effect.ThemeScrollEffect;
import com.amz.ios.themeclub.touch.OverScroll;
import com.amz.ios.themeclub.util.Thunk;
...
//    protected ScrollEffect mScrollEffect;
    ...
    public ThemePagedView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.amz.ios.launcher.R.styleable.PagedView, defStyle, 0);

        mPageLayoutWidthGap = a.getDimensionPixelSize(
                com.amz.ios.launcher.R.styleable.PagedView_pageLayoutWidthGap, 0);
        mPageLayoutHeightGap = a.getDimensionPixelSize(
                com.amz.ios.launcher.R.styleable.PagedView_pageLayoutHeightGap, 0);
        mPageIndicatorViewId = a.getResourceId(com.amz.ios.launcher.R.styleable.PagedView_pageIndicator, -1);
        a.recycle();
