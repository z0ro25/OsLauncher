...
import com.ios.boot.iosboot.animation.ExplosionAnimator;
...
public class ExplosionView extends View {
    ...
    private OnAnimationEndListener mAnimatorListener;
    ...
    public void explode(Rect bound, long startDelay, long duration) {
        final ExplosionAnimator explosion = new ExplosionAnimator(this,bound);
    ...
    public void setOnAnimatorListener(OnAnimationEndListener animatorListener){
    ...
    public void explode(final View view) {
        ...
        int startDelay = 100;
        explode(r, startDelay, ExplosionAnimator.DEFAULT_DURATION);
    }
