...
public class AppWidgetResizeFrame extends FrameLayout {
    ...
    public final LauncherAppWidgetHostView mWidgetView;
    ...
    public void snapToWidget(boolean animate) {
        ...
        if (mLauncher.isOpeningFloatingMenu()) return;
        Log.d(TAG, "*getScaleX() = " + mWidgetView.getScaleX());

        int nWidgetWidth = (int)(mWidgetView.getWidth() * mfWidgetScale);
        int nWidgetHeight = (int)(mWidgetView.getHeight() * mfWidgetScale);

        final DragLayer.LayoutParams lp = (DragLayer.LayoutParams) getLayoutParams();
        int newWidth = nWidgetWidth + 2 * mBackgroundPadding
                - mWidgetPadding.left - mWidgetPadding.right;
        int newHeight = nWidgetHeight + 2 * mBackgroundPadding
