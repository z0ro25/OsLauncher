...
public class UninstallDropTarget extends ButtonDropTarget {
    ...
    private ImageView mTrashHatImageView;
    ...
    protected void onFinishInflate() {
        ...
        mTargetView = findViewById(R.id.uninstall_target_view);
        mTrashImageView = (ImageView) findViewById(R.id.uninstall_target_trash);
        mTrashHatImageView = (ImageView) findViewById(R.id.uninstall_target_trash_hat);

        mEnterAnimator = LauncherAnimUtils.ofPropertyValuesHolder(mTrashHatImageView, PropertyHolderUtis.rotation(0, -15));
        mEnterAnimator.setDuration(100);

        mExitAnimator = LauncherAnimUtils.ofPropertyValuesHolder(mTrashHatImageView, PropertyHolderUtis.rotation(-15, 0));
        mExitAnimator.setDuration(100);
    }
    ...
    public void onDragEnter(DragObject d) {
        super.onDragEnter(d);
        mTrashHatImageView.setPivotX(0);
        mTrashHatImageView.setPivotY(0);
