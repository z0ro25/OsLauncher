...
public abstract class BaseContainerView extends LinearLayout implements Insettable {
    ...
    public BaseContainerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContainerBoundsInset = getResources().getDimensionPixelSize(R.dimen.widgets_container_bounds_inset);
    }
     ...
     */
    protected abstract void onUpdateBackgroundAndPaddings( Rect padding);
