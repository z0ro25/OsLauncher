...
import com.truongnt.ios.launcher.notification.NotificationInfo;
...
public class PopupDataProvider implements NotificationListener.NotificationsChangedListener {
     ...
     * Note that these are in order of priority.
     */
    private static final SystemShortcut[] MY_APP_SHORTCUTS = new SystemShortcut[]{
            new SystemShortcut.AppInfo(),
            new SystemShortcut.Widgets(),
            new SystemShortcut.EditHomeScreen(),
    };
    ...
    public BadgeInfo getBadgeInfoForItem(ItemInfo info) {
        ...
        //for hong test
//        if(mPackageUserToBadgeInfos.size() == 0)
//        {
//            PackageUserKey packageUserKey = new PackageUserKey(info.getTargetComponent().getPackageName(), info.user.getUser());
...
//        }
    ...
    public @NonNull List<SystemShortcut> getEnabledSystemShortcutsForItem(ItemInfo info) {
        ...
        for (SystemShortcut systemShortcut : shortcuts) {
