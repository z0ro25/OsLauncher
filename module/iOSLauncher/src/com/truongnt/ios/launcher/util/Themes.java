...
public class Themes {
    ...
    public static void setTextViewTypeFace(Context context, TextView textView){
        ...
        int fontType = grid.workspaceIconTextFont;
        Typeface face = getTypeFaceForType(context, fontType);
    ...
    public static void setSpacialTypeFace(Context context, int type, TextView textView){
        Typeface face = getTypeFaceForType(context, type);

        if (face != null)
            textView.setTypeface(face);
    }

    private static Typeface getTypeFaceForType(Context context, int type){
