...
import com.truongnt.ios.launcher.widget.WidgetAddFlowHandler;
...
public class PendingRequestArgs extends ItemInfo implements Parcelable {
    ...
    public PendingRequestArgs(Parcel parcel) {
        ...
        UserHandle u = parcel.readParcelable(null);
        user = UserHandleCompat.fromUser(u);
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(user.getUser(), flags);
