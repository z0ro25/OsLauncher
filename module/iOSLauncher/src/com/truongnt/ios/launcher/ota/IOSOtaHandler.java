package com.truongnt.ios.launcher.ota;
...
public class IOSOtaHandler {
    ...
    public static final String ACTION_UPDATE_LABEL = "com.truongnt.ios.launcher.ACTION_UPDATE_LABEL";
    public static final String ACTION_UPDATE_CATEGORY = "com.truongnt.ios.launcher.ACTION_UPDATE_CATEGORY";
    public static final String ACTION_RELOAD_ICON = "com.truongnt.ios.launcher.ACTION_RELOAD_ICON";
    public static final String EXTRA_ICON_ID = "com.truongnt.ios.launcher.EXTRA_ICON_ID";
    public static final String EXTRA_ICON_PATH = "com.truongnt.ios.launcher.EXTRA_ICON_PATH";
    public static final String EXTRA_COMPONENT_NAME = "com.truongnt.ios.launcher.EXTRA_COMPONENT_NAME";
    public static final String EXTRA_APP_LABEL = "com.truongnt.ios.launcher.EXTRA_APP_LABEL";
    public static final String EXTRA_APP_CATEGORY = "com.truongnt.ios.launcher.EXTRA_APP_CATEGORY";
