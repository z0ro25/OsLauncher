package com.truongnt.ios.launcher.accessibility;
...
import com.truongnt.ios.launcher.AppWidgetResizeFrame;
...
import com.truongnt.ios.launcher.DragController.DragListener;
...
import com.truongnt.ios.launcher.PendingAddItemInfo;
...
public class LauncherAccessibilityDelegate extends AccessibilityDelegate implements DragListener {
    ...
    protected long findSpaceOnWorkspace(ItemInfo info, int[] outCoordinates) {
        ...
        screenId = workspace.commitExtraEmptyScreen(Workspace.EXTRA_EMPTY_SCREEN_ID1);
