...
class AppWidgetManagerCompatVL extends AppWidgetManagerCompat {
    ...
    @Override
    public Drawable loadPreview(LauncherAppWidgetProviderInfo info) {
        return info.getPreview(mContext);
    }
    ...
    public Bitmap getBadgeBitmap(LauncherAppWidgetProviderInfo info, Bitmap bitmap,
            int imageHeight) {
        if (info.isIOSWidget || info.getProfile().equals(android.os.Process.myUserHandle())) {
            return bitmap;
        }
