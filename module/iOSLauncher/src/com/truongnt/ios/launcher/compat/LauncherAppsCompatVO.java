...
package com.truongnt.ios.launcher.compat;
...
import com.truongnt.ios.launcher.compat.ShortcutConfigActivityInfo.ShortcutConfigActivityInfoVO;
...
public class LauncherAppsCompatVO extends LauncherAppsCompatVL {
    ...
    public List<ShortcutConfigActivityInfo> getCustomShortcutActivityList(
        ...
        if (packageUser == null) {
            List<UserHandleCompat> userCompats = UserManagerCompat.getInstance(mContext).getUserProfiles();
            users = new ArrayList<>();
            for (UserHandleCompat userCompat : userCompats) {
                users.add(userCompat.getUser());
            }
            packageName = null;
        } else {
