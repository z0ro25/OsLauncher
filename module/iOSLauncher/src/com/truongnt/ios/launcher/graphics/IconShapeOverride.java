 ...
 */
package com.truongnt.ios.launcher.graphics;

import static com.truongnt.ios.launcher.Utilities.getDevicePrefs;
...
import com.truongnt.ios.launcher.util.LooperExecutor;
...
public class IconShapeOverride {
    ...
    private static String getAppliedValue(Context context) {
        Log.d("IOSLite", "IOSLite getAppliedValue xiaopeng");
        boolean mBoolGmsCustomDefault = context.getResources().getBoolean(R.bool.hct_bool_gms_custom_default);
        if(mBoolGmsCustomDefault){
                return getDevicePrefs(context).getString(KEY_PREFERENCE, "m98.5,85c0,7.732 -6.268,14 -14,14l-70,0c-7.732,0 -14,-6.268 -14,-14l0,-70c0,-7.732 6.268,-14 14,-14l70,0c7.732,0 14,6.268 14,14l0,70z");
               
        }else{
                return getDevicePrefs(context).getString(KEY_PREFERENCE,"M50 0C77.6 0 100 22.4 100 50C100 77.6 77.6 100 50 100C22.4 100 0 77.6 0 50C0 22.4 22.4 0 50 0Z");
        }
    }
    ...
    private static class OverrideApplyHandler implements Runnable {
        ...
        public void run() {
            ...
            LauncherAppState.getInstance(mContext).getIconCache().flush();
