...
public class LauncherIcons {
    ...
    public static Bitmap createShortcutIcon(ShortcutInfoCompat shortcutInfo, Context context,
        ...
        Bitmap unbadgedBitmap = unbadgedDrawable == null
                ? cache.getDefaultIcon(UserHandleCompat.fromUser(Process.myUserHandle()))
        ...
        if (cn != null) {
            ...
            appInfo.user = UserHandleCompat.fromUser(shortcutInfo.getUserHandle());
            appInfo.componentName = cn;
            appInfo.intent = new Intent(Intent.ACTION_MAIN)
                    .addCategory(Intent.CATEGORY_LAUNCHER)
                    .setComponent(cn);
            cache.getTitleAndIcon(appInfo, null, false);
            badgeBitmap = appInfo.iconBitmap;
        } else {
            PackageItemInfo pkgInfo = new PackageItemInfo(shortcutInfo.getPackage());
            cache.getTitleAndIconForApp(pkgInfo.packageName, pkgInfo.user, false, pkgInfo);
