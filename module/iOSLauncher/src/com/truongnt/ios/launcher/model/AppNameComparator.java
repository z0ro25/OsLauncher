...
public class AppNameComparator {
    ...
    private final Comparator<AppInfo> mAppInstallTimeComparator;
    ...
    public AppNameComparator(Context context) {
        ...
        mAppInstallTimeComparator = new Comparator<AppInfo>() {
            @Override
            public int compare(AppInfo o1, AppInfo o2) {
                return compareLong(o2.firstInstallTime, o1.firstInstallTime);
            }
        };
    }
    ...
    public Comparator<AppInfo> getAppInfoInstallTimeComparator() {
        return mAppInstallTimeComparator;
    }
