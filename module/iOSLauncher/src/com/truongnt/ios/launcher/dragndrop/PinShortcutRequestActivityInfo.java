...
package com.truongnt.ios.launcher.dragndrop;
...
class PinShortcutRequestActivityInfo extends ShortcutConfigActivityInfo {
    ...
    public Drawable getFullResIcon(IconCache cache) {
        ...
        if (d == null) {
            d = new FastBitmapDrawable(cache.getDefaultIcon(UserHandleCompat.fromUser(Process.myUserHandle())));
        }
        return d;
    }

    @Override
    public com.truongnt.ios.launcher.ShortcutInfo createShortcutInfo() {
