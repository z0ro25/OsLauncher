package com.truongnt.ios.launcher.views;
...
import com.truongnt.ios.ioslite.common.widget.Switch;
...
public class IOSPreference extends LinearLayout {
    ...
    public IOSPreference(Context context, AttributeSet attrs) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, com.truongnt.ios.ioslite.common.R.styleable.IOSPreference);
        ...
        int backgroundResId = array.getResourceId(com.truongnt.ios.ioslite.common.R.styleable.IOSPreference_preferenceBackground, 0);
        if (backgroundResId != 0) {
            mRootView.setBackgroundResource(backgroundResId);
        }

        int iconResId = array.getResourceId(com.truongnt.ios.ioslite.common.R.styleable.IOSPreference_preferenceIcon, 0);
        if (iconResId != 0) {
            mIcon.setVisibility(VISIBLE);
            mIcon.setImageResource(iconResId);
        }

        String title = array.getString(com.truongnt.ios.ioslite.common.R.styleable.IOSPreference_preferenceTitle);
        if (!TextUtils.isEmpty(title)) {
            mTitleText.setText(title);
        }

        int rightIconResId = array.getResourceId(com.truongnt.ios.ioslite.common.R.styleable.IOSPreference_preferenceTitleRightIcon, 0);
        if (rightIconResId != 0) {
            mTitleText.setRightDrawable(rightIconResId);
        }

        String summary = array.getString(com.truongnt.ios.ioslite.common.R.styleable.IOSPreference_preferenceSummary);
        if (!TextUtils.isEmpty(summary)) {
            mSummary.setText(summary);
            mSummary.setVisibility(VISIBLE);
        }

        int titleColor = array.getColor(com.truongnt.ios.ioslite.common.R.styleable.IOSPreference_PreferencetitleColor, context.getResources().getColor(com.truongnt.ios.ioslite.common.R.color.pref_title_selector));
        mTitleText.setTextColor(titleColor);

        int summaryColor = array.getColor(com.truongnt.ios.ioslite.common.R.styleable.IOSPreference_PreferenceSummaryColor, context.getResources().getColor(com.truongnt.ios.ioslite.common.R.color.pref_summary));
        mSummary.setTextColor(summaryColor);

        int rightImg = array.getInteger(com.truongnt.ios.ioslite.common.R.styleable.IOSPreference_rightImage, -1);
        ...
        boolean hideDivider = array.getBoolean(com.truongnt.ios.ioslite.common.R.styleable.IOSPreference_hideDivider, false);
        if (hideDivider) {
