...
public class TopTitlebar extends CardView {
    ...
    public TopTitlebar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.truongnt.ios.ioslite.common.R.styleable.Titlebar, defStyleAttr, 0);
        ...
        int backgroundColor = a.getColor(com.truongnt.ios.ioslite.common.R.styleable.Titlebar_background_color, getResources().getColor(com.truongnt.ios.ioslite.common.R.color.ios_accent_color));
        setBackgroundColor(backgroundColor);

        int backIconTintColor = a.getColor(com.truongnt.ios.ioslite.common.R.styleable.Titlebar_back_color, getResources().getColor(R.color.white));
        mBackIcon.setColorFilter(backIconTintColor);

        String title = a.getString(com.truongnt.ios.ioslite.common.R.styleable.Titlebar_titleText);
        if (!TextUtils.isEmpty(title)) {
            mTitleText.setText(title);
        }

        boolean hideDivider = a.getBoolean(com.truongnt.ios.ioslite.common.R.styleable.Titlebar_hideTitleDivider, true);
        if (hideDivider) {
