...
import com.truongnt.ios.launcher.util.ContentWriter;
...
public class ItemInfo {
     ...
     */
    @ColumnInfo(name = "minSpanX")
    public int minSpanX = 1;

    /**
     * Indicates the minimum Y cell span.
     */
    @ColumnInfo(name = "minSpanY")
     ...
     */
    @ColumnInfo(name = "requiresDbUpdate")
    ...
    @ColumnInfo(name = "wasMovedDueToReducedSpace")
    public boolean wasMovedDueToReducedSpace = false;

    /**
     * The position of the item in a drag-and-drop operation.
     */
    @ColumnInfo(name = "dropPos")
    public int[] dropPos = new int[]{};
    ...
    // is new installed app?
    @ColumnInfo(name = "newInstalled")
    public boolean newInstalled;

    @ColumnInfo(name = "calledNum")
    public long calledNum = 0;

    @ColumnInfo(name = "lastCalledTime")
...
//         tempdebug:
    ...
    public void writeToValues(ContentWriter writer) {
        writer.put(LauncherSettings.Favorites.ITEM_TYPE, itemType)
                ...
                .put(LauncherSettings.Favorites.IS_HIDDEN, isHidden?1:0);
    ...
    public void readFromValues(ContentValues values) {
        ...
        isHidden = values.getAsInteger(LauncherSettings.Favorites.IS_HIDDEN)== 1?true:false;
    }
    ...
    void onAddToDatabase(Context context, ContentValues values) {
        ...
        if (screenId == Workspace.EXTRA_EMPTY_SCREEN_ID1) {
