...
import static com.truongnt.ios.launcher.WorkspaceRootView.DOUBLE_CLICK_TIME_PERIOD;

public class ShortcutAndWidgetContainer extends ViewGroup implements View.OnTouchListener {
            ...
            if (child.getVisibility() != GONE) {
                if (mIsHotseatLayout) {
                    ...
                    if (child instanceof BubbleTextView) {
                        ((BubbleTextView) child).setTextVisibility(showText);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (!mHandled) {
                    mHandled = determineClickGestureStart(event);
                }
