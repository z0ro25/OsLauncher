...
import com.truongnt.ios.ioslite.common.debug.MemoryDumpActivity;
import com.truongnt.ios.ioslite.common.debug.WeightWatcher;
import com.truongnt.ios.ioslite.common.launcher.LauncherRouter;
import com.truongnt.ios.ioslite.common.launcher.LauncherRouter.LauncherDelegate;
import com.truongnt.ios.ioslite.common.launcher.LauncherSettingCallback;
import com.truongnt.ios.ioslite.common.launcher.LauncherSettingSubject;
import com.truongnt.ios.ioslite.common.launcher.LauncherStateManager;
import com.truongnt.ios.ioslite.common.launcher.LauncherWallpaperManager;
import com.truongnt.ios.ioslite.common.launcher.LeftCustomContentCallbacks;
import com.truongnt.ios.ioslite.common.update.VersionUpdateManager;
...
import com.truongnt.ios.launcher.applibrary.DragAppsLibraryLayout;
import com.truongnt.ios.launcher.applibrary.OpenedLibraryView;
import com.truongnt.ios.launcher.assembly.LeftCustomContentUtil;
import com.truongnt.ios.launcher.assembly.SearchWidgetUtil;
import com.truongnt.ios.launcher.awareness.AppUsagesModel;
import com.truongnt.ios.launcher.awareness.SensorGestureModel;
import com.truongnt.ios.launcher.awareness.UnreadCallbacks;
import com.truongnt.ios.launcher.awareness.UnreadLoaderCompact;
import com.truongnt.ios.launcher.bounce.BouncyRecyclerView;
import com.truongnt.ios.launcher.compat.AppWidgetManagerCompat;
import com.truongnt.ios.launcher.compat.LauncherActivityInfoCompat;
import com.truongnt.ios.launcher.compat.LauncherAppsCompat;
import com.truongnt.ios.launcher.compat.LauncherAppsCompatVO;
import com.truongnt.ios.launcher.compat.UserHandleCompat;
import com.truongnt.ios.launcher.compat.UserManagerCompat;
import com.truongnt.ios.launcher.config.GestureEventModel;
import com.truongnt.ios.launcher.config.LauncherSettingActivity;
import com.truongnt.ios.launcher.config.Settings;
import com.truongnt.ios.launcher.dialog.CommonDialog;
import com.truongnt.ios.launcher.folder.Folder;
import com.truongnt.ios.launcher.leftpage.custom.CustomZoomButton;
import com.truongnt.ios.launcher.leftpage.database.WidgetInfo;
import com.truongnt.ios.launcher.leftpage.drawables.ClockDrawable;
import com.truongnt.ios.launcher.leftpage.views.CustomContentView;
import com.truongnt.ios.launcher.logging.FileLog;
import com.truongnt.ios.launcher.model.WidgetsModel;
import com.truongnt.ios.launcher.notification.NotificationListener;
import com.truongnt.ios.launcher.popup.PopupContainerWithArrow;
import com.truongnt.ios.launcher.popup.PopupDataProvider;
import com.truongnt.ios.launcher.provider.AppTypeProvider;
import com.truongnt.ios.launcher.searchview.SearchPullDetector;
import com.truongnt.ios.launcher.searchview.SearchViewLayout;
import com.truongnt.ios.launcher.shortcut.BatterySave;
import com.truongnt.ios.launcher.shortcut.Discovery;
import com.truongnt.ios.launcher.shortcut.Theme;
import com.truongnt.ios.launcher.shortcut.Wallpaper;
import com.truongnt.ios.launcher.shortcuts.DeepShortcutManager;
import com.truongnt.ios.launcher.shortcuts.ShortcutKey;
import com.truongnt.ios.launcher.slideup.SlidingUpPanelLayout;
import com.truongnt.ios.launcher.states.InternalStateHandler;
import com.truongnt.ios.launcher.theme.ThemeManager;
import com.truongnt.ios.launcher.util.AdminManager;
import com.truongnt.ios.launcher.util.BlurWallpaperProvider;
import com.truongnt.ios.launcher.util.ComponentKey;
import com.truongnt.ios.launcher.util.CubicInterpolate;
import com.truongnt.ios.launcher.util.ItemInfoMatcher;
import com.truongnt.ios.launcher.util.LongArrayMap;
import com.truongnt.ios.launcher.util.MultiHashMap;
import com.truongnt.ios.launcher.util.PackageUserKey;
import com.truongnt.ios.launcher.util.SystemUiController;
import com.truongnt.ios.launcher.util.Themes;
...
import com.truongnt.ios.launcher.widget.SlidingUpWidgetsCellAppStyle;
import com.truongnt.ios.launcher.widget.WidgetHostViewLoader;
import com.truongnt.ios.launcher.widget.WidgetsContainerView;
import com.truongnt.ios.rate.LauncherSharePrefUtils;
import com.truongnt.ios.rate.RatingDialog;
import com.truongnt.varunjohn1990.iosdialogs4android.IOSDialog;
import com.truongnt.varunjohn1990.iosdialogs4android.IOSDialogButton;
import com.truongnt.varunjohn1990.iosdialogs4android.IOSDialogMultiOptionsListeners;
...
public class Launcher extends LauncherBaseActivity implements View.OnClickListener,
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION = "com.truongnt.ios.launcher.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    // Type: int
    ...
    private com.truongnt.ios.launcher.widget.view.GlassBlurWindowController mPageIndicatorBlurController;
    private com.truongnt.ios.launcher.widget.view.GlassBlurWindowController mAddWidgetBtnBlur;
    private com.truongnt.ios.launcher.widget.view.GlassBlurWindowController mAddWidgetDoneBtnBlur;
...
//        BlurScreenLayout.a(mFloatingMenuBlurBg,null);
        ...
        android.graphics.drawable.Drawable editBtnFallback =
                new com.truongnt.ios.launcher.widget.view.GlassBlurDrawable(
                        mAddWidgetBtn, glassBtnCorner, glassBtnBorder, 0x40FFFFFF, 0x1AFFFFFF, null);
        mAddWidgetBtnBlur = new com.truongnt.ios.launcher.widget.view.GlassBlurWindowController(
        ...
        mAddWidgetDoneBtnBlur = new com.truongnt.ios.launcher.widget.view.GlassBlurWindowController(
...
//            initApp();
    ...
    private void onSystemPermissionsAnswered(String[] permissions, int[] grantResults) {
        ...
        if (photoGranted) {
            com.truongnt.ios.launcher.widget.widgetprovider.PictureAppWidgetProvider.refreshAll(this);
        }
        if (locationGranted) {
            ...
            com.truongnt.ios.launcher.widget.weather.WeatherRepository.refreshIfStale(this, true);
            com.truongnt.ios.launcher.widget.widgetprovider.WeatherWidgetProvider.refreshAll(this);
        }
    }
...
//    }
    ...
    protected void onResume() {
        ...
        // lần onResume sau.
        com.truongnt.ios.launcher.widget.weather.WeatherRepository.setUpdateListener(new Runnable() {
            @Override
            public void run() {
                com.truongnt.ios.launcher.widget.widgetprovider.WeatherWidgetProvider
        ...
        boolean locationGrantedNow =
                com.truongnt.ios.launcher.widget.weather.WeatherRepository.hasLocationPermission(this);
...
//        }
    ...
    private void setupViews() {
        ...
        if (mPageIndicatorContainer != null && mPageIndicatorBlurController == null) {
            ...
            mPageIndicatorBlurController = new com.truongnt.ios.launcher.widget.view.GlassBlurWindowController(
    ...
    public boolean onLongClick(View v) {
        ...
        if (!mDragController.isDragging()) {
            if (itemUnderLongClick == null) {
                ...
                com.truongnt.ios.launcher.popup.PopupContainerWithArrow openPopup =
                        com.truongnt.ios.launcher.popup.PopupContainerWithArrow.getOpen(this);
                if (openPopup != null) {
                    long sinceOpen = android.os.SystemClock.uptimeMillis() - mContextPopupOpenAt;
                    if (sinceOpen < DUPLICATE_LONG_PRESS_WINDOW_MS) {
                ...
                showingFloatingMenu = true;
                getDragLayer().addView(mFloatingMenuBlurBg, new DragLayer.LayoutParams(-1, -1));
                com.truongnt.ios.launcher.popup.PopupContainerWithArrow popup =
                        com.truongnt.ios.launcher.popup.PopupContainerWithArrow.showForIcon(v);
...
//        }
    ...
    private void setWidgetBlurHiddenRecursive(View v, boolean hidden) {
        if (v == null) return;
        if (v instanceof com.truongnt.ios.launcher.widget.view.WidgetBlurView) {
            ((com.truongnt.ios.launcher.widget.view.WidgetBlurView) v).setPanelHidden(hidden);
            return;
        }
    ...
    /**
     * [BUG FIX] Gỡ XÁC CHẾT của {@link com.truongnt.ios.launcher.popup.PopupContainerWithArrow} còn kẹt
    ...
    private void removeStaleDragLayerOverlays() {
        ...
        for (int i = dragLayer.getChildCount() - 1; i >= 0; i--) {
            ...
            boolean isOverlay =
                    ...
                    || child instanceof com.truongnt.ios.launcher.popup.PopupContainerWithArrow
                    || child instanceof com.truongnt.ios.launcher.editpage.EditPagesOverlay
    ...
    public void dropStaleContextOverlayIfAny() {
        ...
        if (com.truongnt.ios.launcher.popup.PopupContainerWithArrow.getOpen(this) != null) {
    ...
    private void removeStalePopupContainer() {
        ...
        for (int i = dragLayer.getChildCount() - 1; i >= 0; i--) {
            View child = dragLayer.getChildAt(i);
            if (child instanceof com.truongnt.ios.launcher.popup.PopupContainerWithArrow) {
                com.truongnt.ios.launcher.popup.PopupContainerWithArrow popup =
                        (com.truongnt.ios.launcher.popup.PopupContainerWithArrow) child;
                if (!popup.isOpen()) {
    ...
    public boolean isContextPopupOpen() {
        return mContextPopupIcon != null
                && com.truongnt.ios.launcher.popup.PopupContainerWithArrow.getOpen(this) != null;
    }
    ...
    public void showEditMenu(final View anchor) {
        ...
        com.truongnt.ios.launcher.popup.PopupGlassHelper.bind(
                content, com.truongnt.ios.launcher.popup.PopupGlassHelper.widgetPopupCorner(content));
    ...
    public void showEditPages() {
        ...
        com.truongnt.ios.launcher.editpage.EditPagesOverlay overlay =
                new com.truongnt.ios.launcher.editpage.EditPagesOverlay(this);
        overlay.setLayoutParams(new DragLayer.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    public void applyPageChanges(ArrayList<Long> order, java.util.HashSet<Long> hidden) {
        ...
        com.truongnt.ios.launcher.editpage.HiddenPagesPrefs.setHidden(this, hidden);
    ...
    private void restoreHiddenPages() {
        ...
        java.util.Set<Long> hidden =
                com.truongnt.ios.launcher.editpage.HiddenPagesPrefs.getHidden(this);
        if (!hidden.isEmpty()) {
...
interface DebugIntents {
    String DELETE_DATABASE = "com.truongnt.ios.launcher.action.DELETE_DATABASE";
    String MIGRATE_DATABASE = "com.truongnt.ios.launcher.action.MIGRATE_DATABASE";
}