...
import com.truongnt.ios.launcher.widget.weather.WeatherRepository;
...
public class WeatherWidgetProvider extends AppWidgetProvider implements IOSAppWidget {
    ...
    private static void rebindInflatedWeatherWidgets(Context context, View view) {
        ...
        if (view instanceof com.truongnt.ios.launcher.LauncherAppWidgetHostView) {
            com.truongnt.ios.launcher.LauncherAppWidgetProviderInfo info =
                    ((com.truongnt.ios.launcher.LauncherAppWidgetHostView) view)
