...
public class ShortcutInfo extends ItemInfo {
    ...
    /**
     * flag whether app will be uninstalled.
     */
    public boolean uninstallable = false;
    ...
    //save the original application flag
    ...
    public ShortcutInfo(Context context, ShortcutInfo info) {
        ...
        iconBitmap = info.iconBitmap; // TODO: should make a copy here.  maybe we don't need this ctor at all
        customIcon = info.customIcon;
        flags = info.flags;
        appFlags = info.appFlags;
    ...
    public ShortcutInfo(ShortcutInfo shortcutInfo) {
        ...
        this.unreadNum = shortcutInfo.unreadNum;
        this.uninstallable = shortcutInfo.uninstallable;
    }
    ...
    public ShortcutInfo(ShortcutInfoCompat shortcutInfo, Context context) {
        user = UserHandleCompat.fromUser(shortcutInfo.getUserHandle());
    ...
    public static void dumpShortcutInfoList(String tag, String label,
        ...
        for (ShortcutInfo info : list) {
            Log.d(tag, "   title=\"" + info.title + " icon=" + info.iconBitmap
                    + " customIcon=" + info.customIcon);
        }
    }
    ...
    public final boolean isShortcut() {
        return itemType == Favorites.ITEM_TYPE_SHORTCUT;
    }
    ...
    public int getFlags(){
        ...
        if ((appFlags & android.content.pm.ApplicationInfo.FLAG_SYSTEM) == 0) {
            flags |= AppInfo.DOWNLOADED_FLAG;

            if ((appFlags & android.content.pm.ApplicationInfo.FLAG_UPDATED_SYSTEM_APP) != 0) {
                flags |= AppInfo.UPDATED_SYSTEM_APP_FLAG;
            }
        }
    ...
    public String getPackageName() {
        String packageName = "";
        if (promisedIntent != null)
            packageName = promisedIntent.getComponent().getPackageName();
        else if (intent != null) {
    ...
    public static ShortcutInfo fromActivityInfo(LauncherActivityInfoCompat info, Context context) {
        ...
        shortcut.flags = AppInfo.initFlags(context, info);
        shortcut.appFlags = info.getApplicationInfo().flags;
