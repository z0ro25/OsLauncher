 ...
 */
package com.truongnt.ios.launcher.dynamicui;

import static android.app.WallpaperManager.FLAG_SYSTEM;

import static com.truongnt.ios.launcher.Utilities.getDevicePrefs;
import static com.truongnt.ios.launcher.graphics.ColorExtractor.findDominantColorByHue;
...
public class WallpaperManagerCompatVL extends WallpaperManagerCompat {
    ...
    WallpaperManagerCompatVL(Context context) {
        ...
        ContextHelper.registerReceiver(context, new BroadcastReceiver() {
            @Override
