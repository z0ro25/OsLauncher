        ...
        if (appWidget.isIOSWidget || isOwnPackageWidget) {
            ...
            if (pkgName.equals(context.getPackageName())) {
                ...
                if (appWidget.provider != null) {
                    ...
                    if (com.truongnt.ios.launcher.widget.widgetprovider.PictureAppWidgetProvider.class.getName().equals(cls)
                            || com.truongnt.ios.launcher.widget.widgetprovider.PictureMediumWidgetProvider.class.getName().equals(cls)
                            || com.truongnt.ios.launcher.widget.widgetprovider.PictureLargeWidgetProvider.class.getName().equals(cls)) {
                        com.truongnt.ios.launcher.widget.widgetprovider.PictureAppWidgetProvider
                ...
                if (appWidget.provider != null
                        && com.truongnt.ios.launcher.widget.widgetprovider.BatteryWidgetProvider.class
                        .getName().equals(appWidget.provider.getClassName())) {
                    com.truongnt.ios.launcher.widget.widgetprovider.BatteryWidgetProvider
                            .bindInflatedView(context, lahv);
                }
                ...
                if (appWidget.provider != null) {
                    ...
                    if (com.truongnt.ios.launcher.widget.widgetprovider.WeatherWidgetProvider.class.getName().equals(weatherCls)
                            || com.truongnt.ios.launcher.widget.widgetprovider.WeatherMediumWidgetProvider.class.getName().equals(weatherCls)
                            || com.truongnt.ios.launcher.widget.widgetprovider.WeatherLargeWidgetProvider.class.getName().equals(weatherCls)) {
