...
package com.truongnt.ios.launcher.shortcuts;
...
import com.truongnt.ios.launcher.DragView;
...
import com.truongnt.ios.launcher.popup.PopupItemView;
import com.truongnt.ios.launcher.popup.PopupPopulator;
import com.truongnt.ios.launcher.popup.SystemShortcut;
...
public class ShortcutsItemView extends PopupItemView implements View.OnLongClickListener,
    ...
    protected void onAttachedToWindow() {
        ...
        com.truongnt.ios.launcher.popup.PopupGlassHelper.bind(
                this, com.truongnt.ios.launcher.popup.PopupGlassHelper.appPopupCorner(this));
    }
    ...
    public boolean onLongClick(View v) {
        ...
        dragOptions.previewProvider = new ShortcutDragPreviewProvider(sv.getIconView(), mIconShift);
        sv.getIconView().setTag(sv.getFinalInfo());
        DragView dv = mLauncher.getWorkspace().beginDragShared(sv.getIconView(), new Point(),
                (PopupContainerWithArrow) getParent(), false, dragOptions);
