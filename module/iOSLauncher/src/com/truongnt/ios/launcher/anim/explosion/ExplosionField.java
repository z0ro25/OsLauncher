 ...
 */
package com.truongnt.ios.launcher.anim.explosion;
...
public class ExplosionField extends View {
    ...
    private void init() {
        Arrays.fill(mExpandInset, ExplosionUtils.dp2Px(60));
    }
    ...
    public void explode(final View view, final Rect from) {
        Rect r = from;
        ...
        if(r.top<0){
            r.set(r.left,0,r.right,r.bottom+Math.abs(r.top));
        }
