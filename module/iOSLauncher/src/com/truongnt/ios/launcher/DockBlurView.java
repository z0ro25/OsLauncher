...
public class DockBlurView extends RealtimeBlurView {
     ...
     *
     * Dùng lại {@link com.truongnt.ios.launcher.widget.view.GlassBlurDrawable} có sẵn trong dự án — nó
    ...
    private Drawable createBitmapBlurDrawable() {
        try {
            ...
            return new com.truongnt.ios.launcher.widget.view.GlassBlurDrawable(
