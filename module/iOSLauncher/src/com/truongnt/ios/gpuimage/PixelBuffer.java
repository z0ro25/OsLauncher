...
public class PixelBuffer {
    ...
    private void convertToBitmap() {
        ...
        bitmapBuffer.order(ByteOrder.LITTLE_ENDIAN);
        ...
        for (int i = 0; i < height / 2; i++) {
            ...
            System.arraycopy(bitmapBuffer.array(), bitmapBuffer.limit() - bitmapBuffer.position(),
                    bitmapBuffer.array(), bitmapBuffer.position() - width * 4, width * 4);
            System.arraycopy(tmp, 0, bitmapBuffer.array(), bitmapBuffer.limit() - bitmapBuffer.position(), width * 4);
        }
        bitmapBuffer.rewind();
