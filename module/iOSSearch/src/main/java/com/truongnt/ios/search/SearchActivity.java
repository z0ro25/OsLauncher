package com.truongnt.ios.search;
...
import com.truongnt.ios.search.config.SearchConfiguration;
import com.truongnt.ios.search.entities.BaseCardItemInfo;
import com.truongnt.ios.search.entities.IGroupItemInfoImplAdapter;
import com.truongnt.ios.search.provider.SearchDataProvider;
import com.truongnt.ios.search.view.IHeaderSearchView;
import com.truongnt.ios.search.view.ISearchContent;
import com.truongnt.ios.search.view.IWebViewContent;
import com.truongnt.ios.search.widget.ScrollViewExtend;
...
//        mBottomViewProxy.setOnClickListener(this);
        ...
        seperator.setBackgroundColor(getResources().getColor(com.truongnt.ios.ioslite.common.R.color.white50percent));
    }
