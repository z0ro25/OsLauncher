package com.truongnt.ios.search.config;

/**
 * Author       : yizhihao
 * Create time  : 2016-11-16 下午2:00
 * email        : 562536056@qq.com || yizhihao.hut@gmail.com
 */
public class Urls {
    /**
     * get recommad app url
     */
    //http://spb.dd351.com:2610
    public static final String URL_HOT_APP = "http://spb.dd351.com:2610";
    /**
     * search engine url
     */
//    public static final String DEFAULT_SEARCH_ENGINE = "http://web.start.fyi/search?ie=%7binputEncoding%7d&rtag=droi2&source=browser#gsc.q=";
    ...
    //    public static final String DEFAULT_SEARCH_ENGINE = "http://www.baidu.com?&wd="; //for test
