package com.truongnt.ios.ioslite.common;
...
public class Router {
    ...
    public static final String SHORTCUT_BATTERY_SAVE = "com.truongnt.ios.launcher.shortcut.BatterySave";

    public static final String SHORTCUT_BATTERY_WIDGET = "com.truongnt.ios.launcher.shortcut.BatterySave";
    public static final String SHORTCUT_PICTURE_WIDGET = "com.truongnt.ios.launcher.shortcut.BatterySave";
    //快捷设置
    ...
    // 省电模式
    private static final String LAUNCHER = "com.truongnt.ios.launcher.Launcher";
    ...
    public static void startSearchActivityForResult(Activity activity, Bundle extra, int requestCode) {
        ...
        try {
            ...
            intent.setComponent(new ComponentName("com.ios.ioslite.global", "com.truongnt.ios.search.SearchActivity"));
