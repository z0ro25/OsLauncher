...
package com.truongnt.ios.ioslite.common.widget;
...
/**
 * Github : https://github.com/andyxialm/SmoothCheckBox
 * <p/>
 * Add by huangshuai;
 */
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        boolean clickable = ta.getBoolean(R.styleable.SmoothCheckBox_check_box_clickable, true);
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, DisplayUtil.dip2px(getContext(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = DisplayUtil.dip2px(getContext(), DEF_DRAW_SIZE);
