...
public class Partner {
    ...
    public static final String CUSTOM_PACKAGE = "com.ezla.oslauncher.custom";
    public static final String TEST_PACKAGE = "com.ezla.oslauncher.test";
    ...
    /**
     * 客户版本 ： com.ezla.oslauncher.custom 存在则取其中配置，不存在则应用内配置生效
     * 公开版本 ： 只取应用内配置；
     */
