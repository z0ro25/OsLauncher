...
public class CircleButton extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            color = a.getColor(R.styleable.CircleButton_CircleBtncolor, color);
            pressedRingWidth = (int) a.getDimension(R.styleable.CircleButton_CircleBtnRingWidth, pressedRingWidth);
            a.recycle();
        }
