package com.ezla.oslauncher.views.dot_Indicator;

import androidx.annotation.NonNull;
import androidx.recyclerview.widget.RecyclerView;
import androidx.viewpager2.widget.ViewPager2;

public class ViewPager2Attacker extends AbstractViewPagerAttacker<ViewPager2> {
    ...
    @Override
    public void attachToPager(@NonNull final DotIndicator indicator, @NonNull final ViewPager2 pager) {
    ...
    private void updateIndicatorDotsAndPosition(DotIndicator indicator) {
