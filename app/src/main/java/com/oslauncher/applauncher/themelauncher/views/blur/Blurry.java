package com.oslauncher.applauncher.themelauncher.views.blur;
...
public class Blurry {
    ...
    public static class BitmapComposer {
        ...
        public void into(final ImageView target, BlurTask.Callback callback) {
            factor.width = bitmap.getWidth();
            factor.height = bitmap.getHeight();
            ...
            if (async) {
                ...
                Drawable drawable = new BitmapDrawable(context.getResources(), Blur.of(context, bitmap, factor));
                callback.done(Blur.of(target.getContext(), bitmap, factor));
                target.setImageDrawable(drawable);
            }
        }

        public void into(BlurTask.Callback callback) {
            factor.width = bitmap.getWidth();
            factor.height = bitmap.getHeight();
    ...
    public static class ImageComposer {
        ...
        public void into(final ImageView target, BlurTask.Callback callback) {
            ...
            if (async) {
                ...
                Drawable drawable = new BitmapDrawable(context.getResources(), Blur.of(capture, factor));
                callback.done(Blur.of(capture, factor));
                target.setImageDrawable(drawable);
            }
        }
